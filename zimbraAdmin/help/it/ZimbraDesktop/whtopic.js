...
function addButton(sType,nStyle,sText,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sImg1,sImg2,sImg3)
{
	...
	if(sType=="prev")
	{
		if(canGo(false))
		{
			var sTitle="Argomento precedente";
	...
	else if(sType=="next")
	{
		if(canGo(true))
		{
			var sTitle="Argomento successivo";
	...
	else if(sType=="show")
	{
		...
		{
			var sTitle="Mostra il componente di navigazione";
	...
	else if(sType=="hide")
	{
		...
		{
			var sTitle="Nascondi il componente di navigazione";
