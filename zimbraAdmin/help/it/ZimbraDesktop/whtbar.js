...
function addSearchForm()
{
	...
	else if("image"=="image"&&gsIGo)
	{
		...
		sButton+="<img alt=\"Vai\" src=\""+gsIGo+"\" border=0 align=\"absmiddle\"></a></td>";
	}
	sButton+="</tr></table>";
	if(gbNav6)
		sButton+="</form>";
...
function addButton(sType,nStyle,sTitle,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sI1,sI2,sI3,sI4,sI5,sI6)
{
	...
	{
		var svTitle="Mostra il componente di navigazione";
	...
	{
		var svTitle="Nascondi il componente di navigazione";
	...
	{
		var svTitle="Sincronizza Indice";
	...
	{
		var svTitle="Argomento successivo";
	...
	{
		var svTitle="Argomento precedente";
