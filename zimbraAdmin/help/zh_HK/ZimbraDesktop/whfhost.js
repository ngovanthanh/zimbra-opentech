 ...
 */
//	WebHelp 5.10.003
var gsNoTopics="未找到任何主題。";
var gsLoadXmlFailed="錯誤: 無法載入 xml 檔。";
var gsInitDatabaseFailed="錯誤: 無法初始化資料庫。";
var gsNotAllDatabaseInited="警告: 未載入所有的資料庫。可能會找不到部分主題。";
var gsInvalidExpression_1="您輸入的文字並非有效的運算式。";
var gsInvalidExpression_2="請按一下";
var gsInvalidExpression_3="「說明」";
var gsInvalidExpression_4="以了解如何使用查詢運算式 (待完成)。";
var gsSearching="正在搜尋...";
var gsTitle="頭銜";
var gsRank="等級";
var gsCancel="取消";
var gsCanceled="已取消";
