...
var gsLoadingMsg="Carregando, clicar aqui para cancelar...";
var gaProj=null;
...
function writeBook(nIdx)
{
	...
	if(bLocal)
	{
		if (!isBookEmpty(nIdx))
		{
			...
			sHTML+=");return false;\" title=\""+sName+"\"><img alt=\"Livro\" name=\""+getBId(nIdx)+"\" src=\""+sIcon+"\" border=0 align=\"absmiddle\">";
