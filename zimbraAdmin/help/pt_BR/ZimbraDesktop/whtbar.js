...
function addButton(sType,nStyle,sTitle,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sI1,sI2,sI3,sI4,sI5,sI6)
{
	...
	{
		var svTitle="Mostrar componente de navegação";
	...
	{
		var svTitle="Esconder componente de navegação";
	...
	{
		var svTitle="Sincronizar Índice";
