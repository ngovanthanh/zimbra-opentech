...
function addButton(sType,nStyle,sText,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sImg1,sImg2,sImg3)
{
	...
	else if(sType=="show")
	{
		...
		{
			var sTitle="Mostrar componente de navegação";
	...
	else if(sType=="hide")
	{
		...
		{
			var sTitle="Esconder componente de navegação";
