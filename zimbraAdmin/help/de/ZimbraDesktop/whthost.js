...
var gsLoadingMsg="Daten werden geladen. Zum Abbrechen hier klicken...";
var gaProj=null;
...
function writeBook(nIdx)
{
	...
	if(bLocal)
	{
		if (!isBookEmpty(nIdx))
		{
			...
			sHTML+=");return false;\" title=\""+sName+"\"><img alt=\"Buch\" name=\""+getBId(nIdx)+"\" src=\""+sIcon+"\" border=0 align=\"absmiddle\">";
