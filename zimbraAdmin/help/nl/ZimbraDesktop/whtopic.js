...
function addButton(sType,nStyle,sText,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sImg1,sImg2,sImg3)
{
	...
	else if(sType=="show")
	{
		...
		{
			var sTitle="Navigatie gedeelte tonen";
	...
	else if(sType=="hide")
	{
		...
		{
			var sTitle="Navigatie gedeelte niet tonen";
	...
	else if(sType=="synctoc")
	{
		if(gaPaths.length>0)
		{
			var sTitle="Synchroniseren van de inhoudsopgave";
