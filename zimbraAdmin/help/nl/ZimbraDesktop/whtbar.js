...
function addSearchForm()
{
	...
	else if("image"=="image"&&gsIGo)
	{
		...
		sButton+="<img alt=\"Start\" src=\""+gsIGo+"\" border=0 align=\"absmiddle\"></a></td>";
	}
	sButton+="</tr></table>";
	if(gbNav6)
		sButton+="</form>";
...
function addButton(sType,nStyle,sTitle,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sI1,sI2,sI3,sI4,sI5,sI6)
{
	...
	{
		var svTitle="Navigatie gedeelte tonen";
	...
	{
		var svTitle="Navigatie gedeelte niet tonen";
	...
	{
		var svTitle="Synchroniseren van de inhoudsopgave";
	...
	{
		var svTitle="Verklarende woordenlijst";
