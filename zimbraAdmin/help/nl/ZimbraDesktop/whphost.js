	...
	if(gnChecked==0||isSamePath(gaProj[gnChecked].sPPath,aRProj[0].sPPath))
	{
		if(gnChecked!=0)
		{
			if(aRProj[0].sLangId!=gaProj[0].sLangId)
				alert("Het samengevoegde Help-systeem "+aRProj[0].sPPath+" gebruikt een andere taal dan het hoofdhelpsysteem. Het zoeken in de index en in de volledige tekst is daarom niet ingeschakeld in de samengevoegde Help.");
		}
		...
		alert("Kan niet correct worden geladen. Gelieve de 'vernieuwen' knop te selecteren.");
}
