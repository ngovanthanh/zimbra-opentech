 ...
 */
//	WebHelp 5.10.003
var gsNoTopics="Разделов не найдено.";
var gsLoadXmlFailed="Ошибка: не удалось загрузить файл xml.";
var gsInitDatabaseFailed="Ошибка: не удалось инициализировать базу данных.";
var gsNotAllDatabaseInited="Внимание! Не загружены все базы данных. Не все тему будут найдены.";
var gsInvalidExpression_1="Было набрано неверное выражение.";
var gsInvalidExpression_2="Щелкнуть";
var gsInvalidExpression_3="Помощь";
var gsInvalidExpression_4="научиться использовать выражение запроса. (Доработать)";
var gsSearching="Поиск…";
var gsTitle="Название";
var gsRank="Оценить";
var gsCancel="Отмена";
var gsCanceled="Отменено";
