...
var gsLoadingMsg="Загрузка, нажмите здесь для отмены...";
var gaProj=null;
...
function writeBook(nIdx)
{
	...
	if(bLocal)
	{
		if (!isBookEmpty(nIdx))
		{
			...
			sHTML+=");return false;\" title=\""+sName+"\"><img alt=\"Книга\" name=\""+getBId(nIdx)+"\" src=\""+sIcon+"\" border=0 align=\"absmiddle\">";
