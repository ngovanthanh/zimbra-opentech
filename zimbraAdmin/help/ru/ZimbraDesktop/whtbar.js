...
function addSearchForm()
{
	...
	else if("image"=="image"&&gsIGo)
	{
		...
		sButton+="<img alt=\"Вперед\" src=\""+gsIGo+"\" border=0 align=\"absmiddle\"></a></td>";
	}
	sButton+="</tr></table>";
	if(gbNav6)
		sButton+="</form>";
...
function addButton(sType,nStyle,sTitle,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sI1,sI2,sI3,sI4,sI5,sI6)
{
	...
	{
		var svTitle="Показать компонент навигации";
	...
	{
		var svTitle="Скрыть компонент навигации";
