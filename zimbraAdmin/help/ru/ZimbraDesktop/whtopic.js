...
function addButton(sType,nStyle,sText,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sImg1,sImg2,sImg3)
{
	...
	else if(sType=="show")
	{
		...
		{
			var sTitle="Показать компонент навигации";
	...
	else if(sType=="hide")
	{
		...
		{
			var sTitle="Скрыть компонент навигации";
