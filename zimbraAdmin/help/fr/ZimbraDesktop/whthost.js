...
var gsLoadingMsg="Chargement en cours. Cliquer ici pour annuler...";
var gaProj=null;
...
function writeBook(nIdx)
{
	...
	if(bLocal)
	{
		if (!isBookEmpty(nIdx))
		{
			...
			sHTML+=");return false;\" title=\""+sName+"\"><img alt=\"Livre\" name=\""+getBId(nIdx)+"\" src=\""+sIcon+"\" border=0 align=\"absmiddle\">";
