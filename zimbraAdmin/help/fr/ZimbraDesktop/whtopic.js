...
var gsHiliteSearchSetting = "disable,silver,black";
var gsBkgndColor="";
var gsTextColor="";
var BTN_TEXT=1;
var BTN_IMG=2;
...
function addButton(sType,nStyle,sText,sHref,sOnClick,sOnMouseOver,sOnLoad,nWidth,nHeight,sImg1,sImg2,sImg3)
{
	...
	else if(sType=="show")
	{
		...
		{
			var sTitle="Afficher le composant de navigation";
	...
	else if(sType=="hide")
	{
		...
		{
			var sTitle="Ne pas afficher le composant de navigation";
	...
	else if(sType=="synctoc")
	{
		if(gaPaths.length>0)
		{
			var sTitle="Synchronisation de la table des matières";
