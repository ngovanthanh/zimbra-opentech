 ...
 */
//	WebHelp 5.10.003
var gsNoTopics="未找到主题。";
var gsLoadXmlFailed="错误: 未能加载 xml 文件。";
var gsInitDatabaseFailed="错误: 未能初始化数据库。";
var gsNotAllDatabaseInited="警告: 未加载所有数据库。某些主题将会找不到。";
var gsInvalidExpression_1="键入的表达式无效。";
var gsInvalidExpression_2="单击";
var gsInvalidExpression_3="帮助";
var gsInvalidExpression_4="要了解如何使用查询表达式。（待完成）";
var gsSearching="正在搜索...";
var gsTitle="标题";
var gsRank="等级";
var gsCancel="取消";
var gsCanceled="已取消";
